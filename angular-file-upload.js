    ...
    return {
        link: function (scope, element, attributes) {
            ...
            element.bind('change', function () {
                scope.$emit('file:add', this.files ? this.files : this, scope.$eval(attributes.ngFileSelect), attributes.fileUploadId);
...
app.factory('$fileUploader', [ '$compile', '$rootScope', function ($compile, $rootScope) {
    ...
    function Uploader(params) {
        ...
        $rootScope.$on('file:add', function (event, items, options, id) {
            if (this.id === id) {
                event.stopPropagation();
